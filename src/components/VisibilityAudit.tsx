...
const auditItems = [
  {
    ...
    description:
      "The current WordPress site uses generic stock photography instead of your real project images. There are no dedicated pages for Pro Site Work or Concrete — your largest division (65% of revenue) is nearly invisible online. The site occasionally throws access errors and doesn't reflect the scale of a 130-person operation.",
    icon: (
  ...
  },
  {
    ...
    description:
      "No structured data or schema markup for Google. No keyword-optimized landing pages for your core services. No county-specific content for the 11+ counties you serve. Competitors like American Pavement Solutions are actively capturing the search traffic you should own.",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description:
      "No active company LinkedIn, Facebook, or Instagram pages found for Paving Solutions Inc. For a B2B company targeting property managers and developers, LinkedIn alone is a massive untapped channel. Your competitors are actively posting job-site content and getting noticed.",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description:
      'When someone asks ChatGPT or Google AI "who\'s the best paving contractor near me?" — your site needs structured content that AI can read and recommend. Right now, there\'s nothing for AI search tools to surface about your company. We build for this from day one.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
